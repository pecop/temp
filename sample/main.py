...
# Mac
# chrome_path = '/Users/pecop/Desktop/ScrapingBeginner/chromedriver'
chrome_path = './chromedriver'
# Windows
# chrome_path = r'C:\Users\pecop\Desktop\ScrapingBeginner\chromedriver'
...
df.to_csv(f'image_urls_{datetime.datetime.now().strftime("%Y-%m-%d_%H:%M:%S")}.csv', index=False, encoding='utf-8-sig')
